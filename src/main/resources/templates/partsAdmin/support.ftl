<#macro support>
    ...
    <div id="content-header" class="col-xs-12 col-sm-7 col-md-7 col-ld-4">
        <h1 id="content-header-title" class="page-title txt-color-blueDark ml-3" style="display: inline-block;width: 1284px;">Aктивные запросы: <span style="margin-left: 385px">
        ...
        <#if isActive??>
            ...
            <#list isActive as el>
                <tr class="" style="border-left:none;border-right: none; border-top: 1px solid;">
                    <th class="td3">
                        <a class="hreff" href="/kabinet/admin/activeSupport/chat/${el.id}" style="height:80px;padding-top: 30px"><h5 style="margin:0 50px 0;display: inline-block">Номер Запроса:${el.id}</h5>
