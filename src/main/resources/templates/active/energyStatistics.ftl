<#macro energyStatistics>
    <link rel="stylesheet" href="/static/style/profile.css">
    <script type="text/javascript" src="/static/js/kabinet/animete.js"></script>
    <script src="/static/js/kabinet/one.js"></script>
    <script type="text/javascript" src="/static/js/kabinet/two.js"></script>
    <style>
        .mainrightblockmain{
            max-width: 800px;
            border-radius: 0;
    ...
    <div id="content-header" class="col-xs-12 col-sm-7 col-md-7 col-ld-4">
        <h1 id="content-header-title" class="page-title txt-color-blueDark" style="text-align: center;width:800px;">Статистика измения платы за электричество</h1>
    </div>
    <div class="form-group" style="margin:1rem 0 1rem;box-shadow: 0 4px 16px 0 rgba(35, 26, 51, 1);">
        ...
        <form action="/kabinet/energyStatistics" method="post"><#include "../smallBlock/csrf.ftl">
            ...
            <tr>
                <td>
                    <div id="container" class="chart_wrap" >
                    </div>
